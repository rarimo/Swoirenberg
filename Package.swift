...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            ...
            url: "https://github.com/rarimo/Swoirenberg/releases/download/v1.1.2/Swoirenberg.xcframework.zip",
            checksum: "33d7adfd8898dd350d83567883be3c44f8e324931d7e5139a15c8d798377be49"),
        .testTarget(
