...
public func setup_srs_swift<GenericToRustStr: ToRustStr, GenericIntoRustString: IntoRustString>(_ circuit_bytecode: GenericIntoRustString, _ srs_path: Optional<GenericToRustStr>, _ recursive: Bool) -> Optional<UInt32> {
